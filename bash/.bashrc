...
# Load custom directory history tracking
# Load custom directory tracking
if [ -f "$OSH_CUSTOM/scripts/dir_history.sh" ]; then
    source "$OSH_CUSTOM/scripts/dir_history.sh"
fi

# Load TJAM VPN management script
if [ -f "$OSH_CUSTOM/scripts/vpn_tjam.sh" ]; then
    source "$OSH_CUSTOM/scripts/vpn_tjam.sh"
fi
...
alias dotfiles-save="$HOME/.local/bin/dotfiles-save"
